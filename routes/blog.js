...
const { addNewPost,viewAllPost,viewUserPost,updatePost,deletePost,likePost,addComment, viewMyPost } = require('../controllers/BlogControllers');
...
router.get('/viewmypost',[
],fetchuser ,viewMyPost)
